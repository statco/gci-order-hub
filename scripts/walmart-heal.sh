git fetch origin && git checkout claude/cursor-sync-cron
   git commit --allow-empty -m "chore: redeploy to pick up Supabase env vars"
   git push && git checkout main#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
